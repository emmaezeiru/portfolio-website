...
const About = () => {
  return (
    <div class="bg-white" id="about">
        <div class="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 md:mt-0 pt-24 pb-12">
  ...
  {techStack.map((el, index) => (
    <div
      key={index}
      class="flex flex-col items-center justify-center bg-white shadow-md rounded-lg p-4 w-36 h-36"
    >
      <Image
