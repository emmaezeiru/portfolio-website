export const techStack = [
    ...
    { name: "Next", link: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-original.svg" },
    ...
    { name: "Python", link: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" },
    ...
    { name: "Postgresql", link: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postgresql/postgresql-original.svg" },
    { name: "Docker", link: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/docker/docker-original-wordmark.svg" },
  ...
  export const contactLinks = [{ name: 'Stack Overflow', url: 'https://img.icons8.com/external-tal-revivo-color-tal-revivo/40/000000/external-stack-overflow-is-a-question-and-answer-site-for-professional-logo-color-tal-revivo.png', link: 'https://stackoverflow.com/users/19101534/ezeiruemma' },
  { name: 'Instagram', url: 'https://img.icons8.com/doodle/40/000000/instagram-new--v2.png', link: 'https://www.instagram.com/sa.int__/' },
  { name: 'Github', url: 'https://img.icons8.com/doodle/40/000000/github--v1.png', link :'https://github.com/emmaezeiru'},
  { name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png', link: 'https://www.linkedin.com/in/chukwubuikem-ezeiru-elias-538871296'},
  { name: 'X', url: 'https://img.icons8.com/?size=100&id=phOKFKYpe00C&format=png&color=000000', link: 'https://www.x.com/emmaezeiru/'}
  ]
  ...
  export const serviceData = [
    ...
    },
    {
      ...
      desc: `I provide a range of frontend development services
      including creating responsive user interfaces, building dynamic web applications,
      designing seamless user experiences, and integrating modern tools and libraries 
